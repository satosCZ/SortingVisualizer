...
namespace SortingVisualizer.Controls
{
    ...
    public class DarkComboBox : UserControl
    {
        ...
        private Color listBackColor = Color.DarkGray;
        private Color listTextColor = Color.LightGray;
